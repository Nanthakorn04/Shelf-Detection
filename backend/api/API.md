...
Response 200:
```json
{ "success": true, "count": 2, "data": [{ "id": 1, "username": "admin", "role": "admin", "created_at": "2026-08-25 17:00:00" }] }
```

### POST /users.php

สร้างพนักงาน (`role` = staff)

```json
{ "username": "staff01", "password": "1234" }
```

### DELETE /users.php?id=2

ลบพนักงานเท่านั้น ห้ามลบ admin หรือบัญชีตัวเอง
